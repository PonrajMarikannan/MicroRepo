...
@Entity
@Table(name = "ImporterApplications")
public class ImporterApplication {
	...
	public ImporterApplication(Integer applicationId, User user, Ship ship, Status status, Date submissionDate,
			String importerName, String importerEmail, String impPhnum, String exporterName, String exporterEmail,
			String expPhnum, String productName, String productDescription, Double weight, String arrivalCountry,
			byte[] documentFile) {
		super();
		this.applicationId = applicationId;
		this.user = user;
